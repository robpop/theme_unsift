    ...
    <footer class="page-footer font-small primary-color-dark fixed-bottom">
        ...
        <div class="text-left">
            <li class="list-group list-group-horizontal list-group-flush d-flex align-items-center">
                ...
                <a href="tos.html" title="Terms of Service" class="list-group-item primary-color-dark border-0">Terms of Service</a>
                <a href="privacy.html" title="Privacy Policy" class="list-group-item primary-color-dark border-0">Privacy Policy</a>
                ...
                <a href="admin.html" title="Admin" class="list-group-item primary-color-dark border-0">Admin</a>
            </li>
        </div>
